...
#ifndef _INV_ICM207XX_DEFS_H_
#define _INV_ICM207XX_DEFS_H_
...
#if defined USE_ICM207XX
#define MEMS_CHIP  HW_ICM207XX
#endif
...
#define REG_FIFO_EN             MPUREG_FIFO_EN
	...
	#define BIT_ACCEL_OUT                       0x08
	#elif ((MEMS_CHIP == HW_ICM6800)||(MEMS_CHIP == HW_ICM207XX)||(MEMS_CHIP == HW_ICM20609))
	#define BIT_TEMP_OUT                        0x80
...
#define REG_ACCEL_CONFIG_2      MPUREG_ACCEL_CONFIG_2
    #if ((MEMS_CHIP == HW_ICM20690)||(MEMS_CHIP == HW_ICM6800)||(MEMS_CHIP == HW_ICM207XX))
...
enum ANDROID_SENSORS {
	...
	ANDROID_SENSOR_MAGNETOMETER,
	ANDROID_SENSOR_OIS,  // OIS = OIS Gyro
	ANDROID_SENSOR_TEMPERATURE,
    ANDROID_SENSOR_FSYNC_EVENT,
...
#define ODR_MIN_DELAY   1     // Limited by 8-bit HW Gyro rate divider register "GYRO_SMPLRT_DIV"
#define ODR_MAX_DELAY   250   // Limited by 8-bit HW Gyro rate divider register "GYRO_SMPLRT_DIV"
...
#endif  /* #ifndef _INV_ICM207XX_DEFS_H_ */
