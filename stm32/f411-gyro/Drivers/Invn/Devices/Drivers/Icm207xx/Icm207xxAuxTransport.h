 ...
 * ________________________________________________________________________________________________________
 */
/** @defgroup	DriverIcm207xxAuxTransport Icm207xx secondary driver transport
 *  @brief      Low-level Icm207xx secondary interface access. Only supported in ICM20690.
 *  @ingroup 	DriverIcm207xx
 *  @{
*/
#ifndef _INV_ICM207XX_AUX_TRANSPORT_H_
#define _INV_ICM207XX_AUX_TRANSPORT_H_
 ...
 */
int inv_icm207xx_read_secondary(struct inv_icm207xx * s, int index, unsigned char addr, unsigned char reg, char len);
 ...
 *  @return 0 in case of success, -1 for any error
 */
int inv_icm207xx_execute_read_secondary(struct inv_icm207xx * s, int index, unsigned char addr, int reg, int len, unsigned char *d);
 ...
 *  @return 0 in case of success, -1 for any error
 */
int inv_icm207xx_write_secondary(struct inv_icm207xx * s, int index, unsigned char addr, unsigned char reg, char v);
 ...
 *  @return 0 in case of success, -1 for any error
 */
int inv_icm207xx_execute_write_secondary(struct inv_icm207xx * s, int index, unsigned char addr, int reg, unsigned char v);
...
#endif // _INV_ICM207XX_AUX_TRANSPORT_H_
